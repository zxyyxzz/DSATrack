...
from lib.models.grm.vit_stu import vit_base_depth12, vit_base_depth8, vit_base_depth7, vit_base_depth6, vit_base_depth4, vit_tiny_depth12, vit_tiny_depth7, deit_tiny_stu
from lib.utils.box_ops import box_xyxy_to_cxcywh
import math
from lib.models.grm.vit import resize_pos_embed
from lib.models.grm.convert_ckpt import remove_layers
...
def build_grm_stu(cfg, training=True):
    ...
    if cfg.MODEL.BACKBONE.TYPE == 'vit_base_depth12':
        if 'GRM' in cfg.MODEL.PRETRAIN_FILE:
