...
from lib.models.grm.vit import vit_base_patch16_224, vit_tiny_patch16_224, deit_tiny_patch16_224
...
def build_grm(cfg, training=True):
    ...
    if cfg.MODEL.BACKBONE.TYPE == 'vit_base':
        if cfg.MODEL.PRETRAIN_FILE == 'mae_pretrain_vit_base.pth' or 'GRM' in cfg.MODEL.PRETRAIN_FILE:
