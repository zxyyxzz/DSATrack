...
# cfg.MODEL.BACKBONE.SELF_DEFORM = []
cfg.MODEL.BACKBONE.RELEVANCE_ATTN = []
cfg.MODEL.BACKBONE.USING_ATT_WEIGHTS = []
cfg.MODEL.BACKBONE.USING_CLASSIFIERS = [[]]
cfg.MODEL.BACKBONE.DROP_RATIO = []
...
cfg.MODEL.BACKBONE.RESIDUAL = True
cfg.MODEL.BACKBONE.FEATURE_SIZE_Z = 64
cfg.MODEL.BACKBONE.FEATURE_SIZE_X = 256
...
# DATA.VAL
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ['GOT10K_vot_val']
...
cfg.DATA.TEMPLATE.TRAIN_NUMBER = 1
